...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-2.7.13=.', '-fstack-protector-strong', '-fno-strict-aliasing']
CFLAGS_PYEXT = ['-pthread', '-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-2.7.13=.', '-fstack-protector-strong', '-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-2.7.13=.', '-fstack-protector-strong', '-fno-strict-aliasing']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-2.7.13=.', '-fstack-protector-strong', '-fno-strict-aliasing']
CXXFLAGS_PYEXT = ['-pthread', '-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-2.7.13=.', '-fstack-protector-strong', '-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-2.7.13=.', '-fstack-protector-strong', '-fno-strict-aliasing']
...
EXAMPLE_DIRECTORIES = ['udp', 'traffic-control', 'udp-client-server', 'socket', 'tutorial', 'stats', 'naming', 'energy', 'tcp', 'error-model', 'routing', 'matrix-topology', 'realtime', 'wireless', 'ipv6']
...
NS3_EXECUTABLE_PATH = ['/home/aliendjr/repos/SOR2_TP2/ns-allinone-3.27/ns-3.27/build/src/fd-net-device', '/home/aliendjr/repos/SOR2_TP2/ns-allinone-3.27/ns-3.27/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/6', '/home/aliendjr/repos/SOR2_TP2/ns-allinone-3.27/ns-3.27/build']
...
cfg_files = ['/home/aliendjr/repos/SOR2_TP2/ns-allinone-3.27/ns-3.27/build/ns3/config-store-config.h', '/home/aliendjr/repos/SOR2_TP2/ns-allinone-3.27/ns-3.27/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
